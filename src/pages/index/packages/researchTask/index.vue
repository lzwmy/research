<template>
    <div class="researchTask">
        ...
        <div class="cloud-search flex-end-center">
            ...
            <el-button type="text" class="special_btn">课题验证</el-button>
        ...
        <el-dialog 
            ...
            <el-form :model="dialogFrom" ref="refDialogFrom" :rules="formRules" label-width="110px" @submit.native.prevent>
                ...
                <el-form-item label="研究目的/方案:">
                    <el-input type="textarea" :rows="6" v-model.trim="dialogFrom.scheme" placeholder="请输入研究目的" :maxlength="300"></el-input>
                ...
                <el-form-item label="项目说明:">
                    <el-input type="textarea" :rows="6" v-model.trim="dialogFrom.explain" placeholder="请输入项目说明" :maxlength="300"></el-input>
