<template>
  <div v-if="dialogShow">
    <el-dialog title="下拉多选" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-tabs v-model="activeName" @tab-click="handClick">
        <el-tab-pane label="基础设置" name="first">
          <el-form class="alignment" label-width="110px">
            <el-form-item label="可以自由扩展内容" class="line_blockCheck">
              <el-radio-group v-model="isDefaultDate">
                <el-radio label="1">是</el-radio>
                <el-radio label="0">否</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="宽度设置" class="line_blockCheck">
...
<script>
  export default {
    ...
    methods:{
      clickSaveBtn() {
        console.log("保存",this.isDefaultDate,this.basis)
        this.dialogFormVisible = false;
        let newData = this.basicDataInfo;
        newData.obj.baseProperty.controlIsExtend = this.isDefaultDate;
