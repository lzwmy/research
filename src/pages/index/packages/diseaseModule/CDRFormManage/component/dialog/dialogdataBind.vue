<template>
  <div v-if="dialogShow">
    <el-dialog title="设置" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-tabs class="tab_switch" v-model="activeName" @tab-click="handClick">
        ...
        <el-tab-pane  label="数据设置" name="second">
          ...
          <el-form  class="alignment" label-width="80px">
            <el-checkbox v-model="dataSetting.dataBind" >启动数据绑定</el-checkbox>
