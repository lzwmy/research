<template>
  <div v-if="dialogShow">
    <el-dialog title="属性设置" class="dialogHeightSet" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-tabs v-model="activeName" @tab-click="handClick">
        <el-tab-pane label="基础设置" name="first">
          <el-form class="alignment" label-width="80px">
            ...
            <el-form-item v-if="controlType!='DATE'&&controlType!='DATE_TIME'&&controlType!=='FILE_UPLOAD'" label="输入提示" class="line_block">
...
export default {
  ...
  mounted() {
    console.log("单行文本弹框 获取基础数据", this.basicDataInfo);
  },
  created() {
...
.dialogHeightSet .el-dialog__body{
  height: 500px;
  overflow: auto;
}
  .upload-demo{
