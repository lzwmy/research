<template>
    <div v-if="dialogShow">
      <el-dialog title="多行文本框" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
        <el-tabs v-model="activeName" @tab-click="handClick">
          <el-tab-pane label="基础设置" name="first">
            <el-form class="alignment" label-width="80px">
              <el-form-item label="宽度设置" class="line_block">
                <el-select v-model="basis.widthVal" size="mini">
              ...
              <el-form-item label="高度设置" class="line_block">
                <el-input v-model="basis.heightValue" size="mini" placeholder="请输入高度设置"></el-input>
                <span> &nbsp;&nbsp;行</span>
              </el-form-item>
              <el-form-item label="输入提示" class="line_block">
                <el-input v-model="basis.placeholderInfo" size="mini" placeholder="请输入重要的提示"></el-input>
              </el-form-item>
            </el-form>
          </el-tab-pane>
    ...
    export default {
      ...
      methods:{
        clickSaveBtn(){
          ...
          newData.obj.baseProperty.controlWidth = this.basis.widthVal || "";
          newData.obj.baseProperty.controlHeight = this.basis.heightValue || "";
          newData.obj.baseProperty.controlTip = this.basis.placeholderInfo || "";
