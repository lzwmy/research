<template>
  <div>
        ...
        <div class="cloud-search el-form-item-small">
          ...
          <el-form :inline="true" @submit.native.prevent>
            ...
            <el-form-item class="fuzzyQuery">
              <el-input v-model.trim="fuzzyQuery" @change="fuzzyQueryHandle" @keyup.enter.native="fuzzyQueryHandle" size="mini"
    ...
    <reportFollowup v-else @back="hideReportFollowiUp" :dataInfo="reportFollowiUpData" :personalInfo="reportFollowiUpInfo" :reportFillData="reportFillData"></reportFollowup>
  </div>
</template>
