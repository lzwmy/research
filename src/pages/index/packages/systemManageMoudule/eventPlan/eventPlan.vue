<template>
    <div class="cloud-component patientFollowUp">
        <div class="component_head flex-between-center">
            ...
            <div class=" cur_pointer head_content flex-start-center">
                <el-button type="primary"
                           @click="showDialog('添加计划')"
                           icon="el-icon-plus">添加计划</el-button>
            </div>
        </div>
        <!-- 搜索区域 -->
        ...
        <div class="cloud-search-list">
            <echarts-contain containType="big"
                             :parentHeight="routerViewHeight"
                             :heightRatio="1">
                <el-table :height="(dataList.content && dataList.content.length>0)?(routerViewHeight*1-55):(routerViewHeight*1)"
                    ...
                    <el-table-column prop="b"
                                     label="关联表单"></el-table-column>
                    <el-table-column prop="c"
                                     label="定时类型"></el-table-column>
                    <el-table-column prop="d"
                                     label="定时内容"></el-table-column>
                    <el-table-column prop="e"
                                     label="定时范围"></el-table-column>
                    <el-table-column label="状态">
                        <template slot-scope="scope">
                            <el-switch v-model="scope.row.f"
                                       active-color="#13ce66"
                                       inactive-color="#ccc"
                                       style="height: 22px;"></el-switch>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作"
                        ...
                        <template slot-scope="scope">
                            <el-button type="text"
                                       @click="showDialog('编辑计划',scope.row)"><i class="iconfont iconbianji"></i></el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <!-- 分页 -->
        ...
        <el-dialog :title="dialog.title"
            ...
            <el-form :model="dialogFrom"
                ...
                <el-form-item label="事件类型:"
                              class="fill">
                    <el-radio v-model="dialogFrom.eventType"
                              label="1">诊疗事件</el-radio>
                    <el-radio v-model="dialogFrom.eventType"
                              label="2">新培报告事件</el-radio>
                </el-form-item>
                <el-form-item label="诊疗事件:"
                              class="fill">
                ...
                <el-form-item label="延后天数:"
                    ...
                    <el-input type="number"
                              min="1"
                              max="10000"
                              v-model="dialogFrom.delayDay"></el-input>
                </el-form-item>
                <el-form-item label="新增报告事件:"
                              class="fill">
                    <el-select v-model="dialogFrom.addReportEvent">
                        <el-option label="白癜风报告"
                                   value="0"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="定时类型:">
                    <el-select v-model="dialogFrom.timingType"
                               @change="selectChange">
                        <el-option label="无"
                                   value="0"></el-option>
                        <el-option label="按天"
                ...
                <div class="timingType"
                     style="margin-left: 90px;">
                    <el-form-item label="提醒日期:"
                                  label-width="80px"
                                  class="block"
                                  v-if="dialogFrom.timingType==0">
                        <el-date-picker v-model="dialogFrom.modelData.value1"
                                        type="date"
                                        placeholder="选择日期">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label-width="0px"
                                  class="block select"
                                  v-if="dialogFrom.timingType==1">
                        每<el-input class="width_auto"
                    ...
                    <el-form-item label-width="0px"
                                  class="block select"
                                  v-if="dialogFrom.timingType==2">
                        每<el-input v-model="dialogFrom.modelData.value1"
                                  type="number"
                                  min='1'></el-input>周
                        <div class="block week">
                            <el-radio v-model="dialogFrom.modelData.value2"
                                      label="1">周一</el-radio>
                            <el-radio v-model="dialogFrom.modelData.value2"
                                      label="2">周二</el-radio>
                            <el-radio v-model="dialogFrom.modelData.value2"
                    ...
                    <el-form-item label-width="0px"
                        ...
                        <el-select v-model="dialogFrom.modelData.value2">
                            <el-option v-for="(item, index) in selectDayArr"
                                       :label="item"
                                       :value="index+1"></el-option>
                        </el-select>日
                    </el-form-item>
                ...
                <el-form-item label="持续时间:"
                              class="block">
                    <el-input class="width_auto"
                              type="number"
                              min="1"
                              max="10000"
                              v-model="dialogFrom.time"></el-input>
