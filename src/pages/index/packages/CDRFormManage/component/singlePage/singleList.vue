    ...
    <div class="entry_search">
      <el-form :inline="true" :model="formInline">
        ...
        <el-form-item>
          ...
          <el-button @click="newEntry">定义新单页</el-button>
        </el-form-item>
      </el-form>
    </div>
  ...
  export default {
    ...
    methods:{
      ...
      modifyData(value){
        ...
        this.$emit("add-change",{type:'modifySinglePage',clickType:'modifySinglePage',obj:value})
      },
      previewPage(value){
      ...
      //新增单页
      newEntry(){
        this.$emit("add-change",{type:'addSinglePage',clickType:'addSinglePage',obj:{}})
      },
      //获取 小节列表
      async getFormItemList(pageNo = this.pageNo, pageSize = this.pageSize){
        ...
        let formData = {
          "args": {
            ...
            "pageName": that.formInline.entryName ||"",
            "formType": 'fromPage'
          },
          "limit": pageSize,
          "offset": pageNo-1
      ...
      async batchDeletion(){
        ...
        try {
          let data = await that.$http.crfSinglePageDel(that.$format(formData))
          console.log(data)
          if(data.code===0){
            that.$message({
              type:"success",
