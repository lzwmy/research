...
const url = {
    ...
    //删除病种自定义图片
    diseaseSpeciesDeleteFile: '/manage/diseaseSpecies/setup/deleteFile/'
};

const http = {
    diseaseSpeciesDeleteFile (params) {
        return vm.$get(url.diseaseSpeciesDeleteFile+params, null, true);
    },
