  ...
  methods: {
    initPage () {
      ...
      _this.editor = window.KindEditor.create('#' + this.id, {
        ...
        afterBlur: _this.afterBlur, // 将编辑器的内容设置到原来的textarea控件里。
        afterUpload: _this.afterUpload,
        uploadJson: _this.uploadJson, // 指定上传文件的服务器端程序
        fileManagerJson: _this.fileManagerJson, // 指定浏览远程图片的服务器端程序
        ...
        allowFileManager: _this.allowFileManager, // true时显示浏览远程服务器按钮。
